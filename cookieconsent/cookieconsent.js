    ...
    window.CookieConsent.config = {
      ...
      language: {
        ...
        locale: {
          ...
          de: {
            barMainText: 'Diese Website verwendet Cookies, um sicherzustellen, dass Sie die beste Erfahrung auf unserer Website erhalten.',
            barLinkSetting: 'Cookie-Einstellungen',
            barBtnAcceptAll: 'Alle akzeptieren',
            modalMainTitle: 'Cookie-Einstellungen',
            modalMainText: 'Cookies sind kleine Datenelemente, die von einer Website gesendet und vom Webbrowser des Benutzers auf dem Computer des Benutzers gespeichert werden, während der Benutzer surft. Ihr Browser speichert jede Nachricht in einer kleinen Datei namens Cookie. Wenn Sie eine weitere Seite vom Server anfordern, sendet Ihr Browser das Cookie an den Server zurück. Cookies wurden als zuverlässiger Mechanismus für Websites entwickelt, um Informationen zu speichern oder die Browsing-Aktivitäten des Benutzers aufzuzeichnen.',
